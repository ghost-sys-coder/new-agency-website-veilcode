...
export const PROJECTS: Project[] = [
  /* ── 01 NEXUS COMMERCE ─────────────────────────────────────────────────── */
  {
    ...
    screenshots: [
      { src: null, alt: "Nexus Commerce homepage — desktop",         caption: "Homepage — desktop view",               size: "wide" },
      { src: null, alt: "Nexus Commerce product listing page",       caption: "Product listing page",                  size: "half" },
      { src: null, alt: "Nexus Commerce product detail page",        caption: "Product detail page",                   size: "half" },
      { src: null, alt: "Nexus Commerce mobile checkout flow",       caption: "Mobile checkout — step 1 of 2",         size: "half" },
      { src: null, alt: "Nexus Commerce order confirmation screen",  caption: "Order confirmation",                    size: "half" },
      { src: null, alt: "Nexus Commerce admin CMS dashboard",        caption: "Sanity CMS — product management",       size: "wide" },
    ],
    testimonial: {
  ...
  /* ── 02 FLOWMETRICS ─────────────────────────────────────────────────────── */
  {
    ...
    screenshots: [
      { src: null, alt: "FlowMetrics main analytics dashboard",      caption: "Main KPI dashboard — live view",         size: "wide" },
      { src: null, alt: "FlowMetrics revenue breakdown chart",       caption: "Revenue breakdown — drill-down view",    size: "half" },
      { src: null, alt: "FlowMetrics pipeline health monitor",       caption: "Pipeline health monitor",                size: "half" },
      { src: null, alt: "FlowMetrics data lineage diagram",          caption: "dbt lineage graph",                      size: "wide" },
    ],
    testimonial: {
  ...
  /* ── 03 VANTAGE AI ──────────────────────────────────────────────────────── */
  {
    ...
    screenshots: [
      { src: null, alt: "Vantage agent orchestration dashboard",     caption: "Agent orchestration — live activity view",  size: "wide" },
      { src: null, alt: "Vantage document ingestion pipeline",       caption: "Document ingestion pipeline",               size: "half" },
      { src: null, alt: "Vantage human review queue",                caption: "Human-in-the-loop review queue",            size: "half" },
      { src: null, alt: "Vantage compliance screening results",      caption: "Compliance pre-screening results",          size: "half" },
      { src: null, alt: "Vantage agent performance metrics",         caption: "Agent performance metrics",                 size: "half" },
    ],
    testimonial: {
  ...
  /* ── 04 TRADEPOST ───────────────────────────────────────────────────────── */
  {
    ...
    screenshots: [
      { src: null, alt: "TradePost home feed — Android",             caption: "Home feed — Android",                    size: "half" },
      { src: null, alt: "TradePost listing detail page",             caption: "Listing detail view",                    size: "half" },
      { src: null, alt: "TradePost search and filter screen",        caption: "Search & filter",                        size: "half" },
      { src: null, alt: "TradePost seller profile page",             caption: "Seller profile",                         size: "half" },
      { src: null, alt: "TradePost in-app messaging",                caption: "In-app messaging",                       size: "wide" },
    ],
    testimonial: {
  ...
  /* ── 05 BREWED ──────────────────────────────────────────────────────────── */
  {
    ...
    screenshots: [
      { src: null, alt: "Brewed Instagram profile grid",             caption: "Instagram profile — 6-month grid",       size: "wide" },
      { src: null, alt: "Brewed top-performing reel screenshot",     caption: "Top-performing reel (380K views)",        size: "half" },
      { src: null, alt: "Brewed Meta Ads campaign results",          caption: "Meta Ads Manager — campaign results",    size: "half" },
      { src: null, alt: "Brewed TikTok content performance",         caption: "TikTok analytics overview",              size: "wide" },
    ],
    testimonial: {
  ...
  /* ── 06 MERIDIAN ────────────────────────────────────────────────────────── */
  {
    ...
    screenshots: [
      { src: null, alt: "Meridian homepage — desktop",               caption: "Homepage — desktop",                     size: "wide" },
      { src: null, alt: "Meridian practice area page",               caption: "Practice area detail page",              size: "half" },
      { src: null, alt: "Meridian attorney profile page",            caption: "Attorney profile",                       size: "half" },
      { src: null, alt: "Meridian resource library",                 caption: "Gated resource library",                 size: "half" },
      { src: null, alt: "Meridian mobile homepage",                  caption: "Mobile — homepage",                      size: "half" },
    ],
    testimonial: {
  ...
  /* ── 07 AGRIDATA ────────────────────────────────────────────────────────── */
  {
    ...
    screenshots: [
      { src: null, alt: "AgriData map dashboard — farm network view",  caption: "Farm network — map dashboard",           size: "wide" },
      { src: null, alt: "AgriData yield vs weather correlation chart",  caption: "Yield vs weather correlation",           size: "half" },
      { src: null, alt: "AgriData intervention tracking panel",         caption: "Intervention tracking",                  size: "half" },
      { src: null, alt: "AgriData mobile data collection app",          caption: "Field officer mobile app",               size: "wide" },
    ],
    testimonial: {
  ...
  /* ── 08 HEALTHPULSE ─────────────────────────────────────────────────────── */
  {
    ...
    screenshots: [
      { src: null, alt: "HealthPulse home screen — iOS",             caption: "Home screen — iOS",                      size: "half" },
      { src: null, alt: "HealthPulse appointment booking flow",      caption: "Appointment booking flow",               size: "half" },
      { src: null, alt: "HealthPulse teleconsultation screen",       caption: "In-app video consultation",              size: "half" },
      { src: null, alt: "HealthPulse lab results view",              caption: "Lab results — push notification + view", size: "half" },
      { src: null, alt: "HealthPulse prescription history",          caption: "Prescription history",                   size: "wide" },
    ],
    testimonial: {
