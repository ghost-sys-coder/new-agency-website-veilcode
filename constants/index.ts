...
export const MYPROJECTS: Project[] = [
  {
    ...
    desc:        "Enterprise-grade ATS powered by AI — analyses CVs, scores candidates, and surfaces insights for recruiters using Next.js and MongoDB.",
    metric:      "AI-Powered",
    metricLabel: "ATS Platform",
  ...
  },
  {
    tag:         "Web + AI",
    title:       "Chat-2-My-PDF",
    desc:        "AI SaaS app that lets users upload PDFs and have intelligent conversations with their documents — built with Next.js and LLM integration.",
    metric:      "LLM",
  ...
  {
    tag:         "Dashboard",
    title:       "RealtyProp Real Estate Dashboard",
    desc:        "Full-featured admin dashboard for a real estate platform — property listings, analytics, and tenant management built with React.",
    metric:      "Full-Stack",
    metricLabel: "Admin Dashboard",
  ...
  },
  {
    ...
    desc:        "A full-featured digital agency website showcasing services, portfolio, and client-facing pages — built with Next.js for performance and SEO.",
    metric:      "SEO",
    metricLabel: "Optimised",
  ...
  {
    tag:         "Web App",
    title:       "ShopLocker Ecommerce",
    desc:        "A clean, modern ecommerce experience built with Next.js — product browsing, cart management, and a seamless checkout experience.",
    metric:      "Next.js",
  ...
  {
    tag:         "Web App",
    title:       "Ecommerce Store with Sanity",
    desc:        "Headless ecommerce storefront powered by Sanity CMS — product pages, cart, checkout flow, and real-time content updates.",
    metric:      "Headless",
    metricLabel: "CMS Powered",
  ...
  {
    tag:         "Business",
    title:       "Inspire Me Salon Website",
    desc:        "Business website for a premium salon brand — services, gallery, booking info, and brand storytelling with a polished UI.",
    metric:      "Brand",
